                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control" id="answer1"
                                                aria-describedby="answer1" placeholder="Enter Choice 1" value="{{old('answers.0.answer')}}">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control" id="answer2"
                                                aria-describedby="answer2" placeholder="Enter Choice 2" value="{{old('answers.1.answer')}}">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control" id="answer3"
                                                aria-describedby="answer3" placeholder="Enter Choice 3" value="{{old('answers.2.answer')}}">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control" id="answer4"
                                                aria-describedby="answer4" placeholder="Enter Choice 4" value="{{old('answers.3.answer')}}" >
